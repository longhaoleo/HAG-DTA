#!/bin/bash
# run_kiba_graphdta.sh - KIBA GraphDTA baseline, single seed.
# Usage: bash scripts/run_kiba_graphdta.sh <seed> [models]
...
usage() {
    echo "Usage: bash scripts/run_kiba_graphdta.sh <seed> [models]"
...
LOG_NAME="kiba_graphdta_s${SEED}.log"
...
log "========== KIBA GraphDTA seed=$SEED models=$MODELS =========="
...
log "========== KIBA GraphDTA seed=$SEED COMPLETE =========="
